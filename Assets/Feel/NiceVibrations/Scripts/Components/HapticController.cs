...
namespace Lofelt.NiceVibrations
{
    ...
    public static class HapticController
    {
        ...
        const string HapticsEnabledPrefsKey = "NV_HapticsEnabled";
        static bool hapticsEnabledLoadedFromPrefs = false;
        ...
        static void LoadHapticsEnabledFromPrefsIfNeeded()
        {
            if (hapticsEnabledLoadedFromPrefs)
            {
                return;
            }

            if (PlayerPrefs.HasKey(HapticsEnabledPrefsKey))
            {
                _hapticsEnabled = PlayerPrefs.GetInt(HapticsEnabledPrefsKey, 1) == 1;
            }

            hapticsEnabledLoadedFromPrefs = true;
        }

        static void SaveHapticsEnabledToPrefs(bool enabled)
        {
            PlayerPrefs.SetInt(HapticsEnabledPrefsKey, enabled ? 1 : 0);
            PlayerPrefs.Save();
        }
        ...
        public static bool hapticsEnabled
        {
            get
            {
                LoadHapticsEnabledFromPrefsIfNeeded();
            ...
            set
            {
                ...
                SaveHapticsEnabledToPrefs(value);
            }
        }
