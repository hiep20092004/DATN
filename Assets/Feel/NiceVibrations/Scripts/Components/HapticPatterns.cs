    ...
    public static class HapticPatterns
    {
        ...
        internal struct Preset
        {
            ...
            public float GetDuration()
            {
                ...
                {
                    return maximumAmplitudePattern[^1];
                }
                else
                {
                    return 0f;
        ...
        static HapticPatterns()
        {
            ...
            Soft = new Preset(PresetType.SoftImpact, new [] { 0.000f, 0.045f },
                                                     new [] { 0.064f, 0.064f });

            Success = new Preset(PresetType.Success, new [] { 0.0f, 0.040f, 0.080f, 0.240f },
                                                     new [] { 0.0f, 0.064f, 0.000f, 0.600f });

            Failure = new Preset(PresetType.Failure,
                                 new [] { 0.000f, 0.020f, 0.080f, 0.160f, 0.260f, 0.380f, 0.540f, 0.740f, 0.940f, 1.120f, 1.280f },
                                 new [] { 0.000f, 0.600f, 0.468f, 0.372f, 0.300f, 0.234f, 0.168f, 0.114f, 0.072f, 0.036f, 0.000f });

            Warning = new Preset(PresetType.Warning, new [] { 0.0f, 0.120f, 0.240f, 0.280f },
                                                     new [] { 0.0f, 0.600f, 0.000f, 0.282f });

            Deny = new Preset(PresetType.Deny, new[] { 0.0f, 0.040f, 0.045f, 0.120f, 0.192f },
                                            new[] { 0.0f, 0.880f, 0.000f, 0.77f, 0.000f });
        }
