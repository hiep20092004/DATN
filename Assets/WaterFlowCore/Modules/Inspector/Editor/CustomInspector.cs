...
namespace WaterFlow.Core
{
    ...
    public class CustomInspector : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (showScriptField)
            {
                if (scriptProperty is { serializedObject: not null })
                {
            ...
            // Apply modified properties safely.
            try
            {
            ...
            {
                // If ApplyModifiedProperties fails (serialized object disposed), ignore and return.
                return;
            }
