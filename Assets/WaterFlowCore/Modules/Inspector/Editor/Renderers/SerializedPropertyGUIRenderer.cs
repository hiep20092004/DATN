            ...
            if (EditorGUI.EndChangeCheck())
            {
                ...
                if (onValueChangedAttribute != null)
                {
                    ...
                    if (editor.targets.Length > 1)
                    {
                        ...
                        {
                            Debug.LogWarning(
                                $"OnValueChange callback can't be performed. Method {onValueChangedAttribute.CallbackName} is missing or has a different structure (void return type and no parameters)");
                        }
                    }
                    else
                    {
            ...
            if (inlineButtonAttribute != null)
            {
                ...
                if (GUILayout.Button(buttonContent, buttonStyle, GUILayout.Width(buttonWidth)))
                {
                    ...
                    if (editor.targets.Length > 1)
                    {
                        ...
                        {
                            Debug.LogWarning(
                                $"InlineButton callback can't be performed. Method {inlineButtonAttribute.MethodName} is missing or has a different structure (void return type and no parameters)");
                        }
                    }
                    else
                    {
