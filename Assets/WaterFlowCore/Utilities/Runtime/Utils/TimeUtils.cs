...
namespace WaterFlow.Core
{
    ...
    {
        private static readonly DateTime DEFAULT_DATE_UNIX = new DateTime(1970, 1, 1, 0, 0, 0, DateTimeKind.Utc);
        ...
        /// </summary>
        /// <returns>The current Unix timestamp as a long.</returns>
        ...
        /// <returns>The Unix timestamp with the specified extra time as a long.</returns>
        public static long GetCurrentUnixTimestampWithExtraTime(int weeks = 0, int days = 0, int hours = 0, int minutes = 0, int seconds = 0)
        {
            ...
            return nowDate.ToUnixTimeSeconds();
        }
