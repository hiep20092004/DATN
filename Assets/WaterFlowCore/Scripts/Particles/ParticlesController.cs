...
namespace WaterFlow.Core
{
    ...
    {
        // Database asset holding the particles to be registered and managed.
        [SerializeField] ParticleDatabase particleDatabase;
        ...
        public void Init()
        {
            ...
            {
                Debug.LogError("[Particle Controller]: No ParticleDatabase assigned!");
            }
            else
            {
                // Register particles from the database.
                Particle[] particles = particleDatabase.Particles;
