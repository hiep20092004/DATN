...
namespace WaterFlow.Core
{
    ...
    public static class CoreEditor
    {
        ...
        public static string FOLDER_CORE_NAME = "WaterFlow.Core";
        public static string CORE_SETTING_NAME = "Core Settings.asset";
        ...
        public static bool ShowPromotions { get; private set; } = true;
        ...
        private static void Init()
        {
            ...
            if (!coreSettings)
            {
                ...
                Debug.LogWarning("[Core]: Core Settings asset cannot be found in the project. This asset is required for the proper functionality of the modules.");

                coreSettings = ScriptableObject.CreateInstance<CoreSettings>();

                FOLDER_CORE = Path.Combine("Assets", FOLDER_CORE_NAME);

                if (!AssetDatabase.IsValidFolder(FOLDER_CORE))
                {
                    AssetDatabase.CreateFolder("Assets/", FOLDER_CORE_NAME);
                }

                AssetDatabase.CreateAsset(coreSettings, Path.Combine("Assets", FOLDER_CORE_NAME, CORE_SETTING_NAME));
        ...
        public static void ApplySettings(CoreSettings settings)
        {
            ...
            // Other
            ShowPromotions = settings.ShowPromotions;
        }
