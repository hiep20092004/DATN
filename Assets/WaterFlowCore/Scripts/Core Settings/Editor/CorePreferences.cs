...
namespace WaterFlow.Core
{
    public static class CorePreferences
    {
        ...
        public static SettingsProvider CustomPreferencesMenu()
        {
            ...
            SettingsProvider provider = new SettingsProvider("Preferences/WaterFlow Core", SettingsScope.User)
            {
                // Label of the preferences page
                label = "WaterFlow Core",
                ...
                keywords = new string[] { "Custom", "Preferences", "WaterFlow Core", "Core" }
            };
