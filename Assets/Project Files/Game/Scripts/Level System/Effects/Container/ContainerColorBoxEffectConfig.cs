...
{
    [CreateAssetMenu(menuName = "WaterFlow/Block Effects/Container Color Box Effect Config")]
    public sealed class ContainerColorBoxEffectConfig : BaseContainerBoxEffectConfig
    {
    ...
    [Serializable]
    public class ContainerColorBoxVisualConfig : BaseContainerBoxVisualConfig
    {
