...
namespace WaterFlow.Game
{
    public abstract class LevelEditorBase : EditorWindow
    {
        ...
        public string LEVELS_FOLDER_PATH
        {
            get => LevelSystemUtils.SourceLevelsFolder;
        }

        protected virtual string LEVELS_FOLDER_NAME
        {
            get => "Levels";
        }

        protected virtual string LEVELS_DATABASE_FOLDER_PATH
        {
            get => LevelSystemUtils.LevelSystemDataFolder;
        }

        protected Color DefaultGUIColor
        {
            get => defaultGUIColor;
        }

        public static float SINGLE_LINE_HEIGHT
        {
            get => EditorGUIUtility.singleLineHeight;
        }

        public static float LABEL_WIDTH
        {
        ...
        [MenuItem("Tools/Level Editor", priority = 0)]
        ...
        static Type GetChildType()
        {
            ...
            {
                foreach (Type classType in assembly.GetLoadableTypes())
                {
        ...
        public virtual void DisplayPropertiesTab()
        {
            ...
            if (!enumerator.MoveNext())
            {
                EditorGUILayout.HelpBox(
                    "This tab is used to display database fields without [LevelEditorSetting] attribvute.",
                    MessageType.Info);
                return;
            }
        ...
        protected abstract Type GetLevelsDatabaseType();
        public abstract Type GetLevelType();
        ...
        {
            if ((windowConfiguration != null) && (!windowConfiguration.KeepWindowOpenOnScriptReload) &&
                (window != null))
            {
                window.Close();
            }
        ...
        public void OnGUI()
        {
            ...
            if (windowConfiguration.RestictContentHeight)
            {
                EditorGUILayout.BeginVertical(GUILayout.MaxWidth(windowConfiguration.ContentMaxSize.x),
                    GUILayout.MaxHeight(windowConfiguration.ContentMaxSize.y));
            }
            else
            {
                EditorGUILayout.BeginVertical(GUILayout.MaxWidth(windowConfiguration.ContentMaxSize.x));
        ...
        private void DrawCreateLevelDatabase()
        {
            ...
            {
                AssetDatabase.CreateAsset(ScriptableObject.CreateInstance(GetLevelsDatabaseType()),
                    LEVELS_DATABASE_FOLDER_PATH + PATH_SEPARATOR + LEVEL_DATABASE_ASSET_FULL_NAME);
        ...
        // Only for visual
        public virtual string GetLevelLabelSuffix(UnityEngine.Object levelObject)
        {
            return string.Empty;
        }

        /// <summary>
        /// Final row text for <see cref="WaterFlow.Core.CustomList"/> level entries.
        /// Default appends <paramref name="validationSuffix"/> to <paramref name="labelWithoutValidationSuffix"/>.
        /// </summary>
        public virtual string FormatLevelListRowLabel(
            int index,
            ...
            string validationSuffix)
        {
            ...
            return labelWithoutValidationSuffix + validationSuffix;
        }
        ...
        // Level editor asset representation moved to `LevelEditorLevelRepresentationBase.cs`
    }
}