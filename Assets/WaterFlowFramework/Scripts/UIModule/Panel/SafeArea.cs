...
namespace WaterFlow.Framework.UIModule
{
    ...
    public class SafeArea : MonoBehaviour
    {
        ...
        /// <summary>
        ///     Raised after the safe area has been applied to this panel, so dependents (e.g. the Home navigator)
        ///     can reposition themselves against the freshly-resolved safe area.
        /// </summary>
        public event Action ScaleComplete;

        /// <summary>
        ///     Bottom safe-area inset in screen pixels (distance the safe area is pushed up from the screen bottom).
        /// </summary>
        public float BottomInsetPixels => LastSafeArea.y;
